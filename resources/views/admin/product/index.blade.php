        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.product.store') }}">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="mb-3 row"> <label class="col-lg-2 col-md-6 col-sm-12 col-form-label">Name:</label>
                            <div class="col-lg-10 col-md-6 col-sm-12"> <input name="name" value="{{ old('name') }}"
                                    type="text" class="form-control"> </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-3 row"> <label class="col-lg-2 col-md-6 col-sm-12 col-form-label">Price:</label>
                            <div class="col-lg-10 col-md-6 col-sm-12"> <input name="price" value="{{ old('price') }}"
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="file" id="formFile" value="{{ old('image') }}">
                </div>
